...
global C0 epsilon lambda phi_init
if t == 0
    phi0 = phi_init;
end
...
energy_phi = lambda*fun_inner(1,1./2*epsilon*lap_diff(phi0).^2);

energy_modified = energy_phi + energy_part2 + lambda*(U^2-C0) + 1./2*(Q-1) ;
