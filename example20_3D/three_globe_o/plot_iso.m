...
dirname = 'ex20_BDF2_3D_CAC_Vesicles_data_LM_three_globe';
...
kk = 0;
% figure(4) 
% for t= [0:0.04:0.76 1.44 1.6 1.8 2]
for t = 0:0.04:2
% for t = 0
t 
...
%     set(gca,'ztick',[])
    ...
    figname = ['C:\Users\Administrator\Desktop\论文\figs\3D\18a\',dirname,'_phi_t=' num2str(t) '.png'];
