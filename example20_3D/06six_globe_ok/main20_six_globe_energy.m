...
elseif 1 == strcmp(scheme,'MSAV_1st')
    solver_fun = @CAC1_Vesicle_3D_MSAV_1st;
elseif 1 == strcmp(scheme,'MSAV_bdf2')
    solver_fun = @CAC1_Vesicle_3D_MSAV_bdf2;
end
...
figname1 = ['C:\Users\heyan\Desktop\some files\figs\deformation\3Dsix_globes\',para.name,'_Original_energy','.png'];
...
figname2 = ['C:\Users\heyan\Desktop\some files\figs\deformation\3Dsix_globes\',scheme,'_2D_surface','.png'];
