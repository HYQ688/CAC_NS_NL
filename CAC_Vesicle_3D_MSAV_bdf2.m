function [phi, u1, v1] = CAC_Vesicle_3D_MSAV_bdf2(pde,domain,Nx,Ny,Nz,time,option)
...
[phi1,u1,v1] = CAC_Vesicle_3D_MSAV_1st(pde,domain,Nx,Ny,Nz,time1,option);
