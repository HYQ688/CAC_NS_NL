...
% Initial energy
if 1 == option.energyflag
    calculate_energy1(out1,out2,t,phi0,u0,v0);
end
...
%         rhs = rhs./M;
    ...
    g12 = -(u_star.*diff_x(phi_star) + v_star.*diff_y(phi_star))./gamma./lambda;
...
%     eta = 1;
    ...
    if 1 == option.energyflag
        calculate_energy1(out1,out2,t,phi0,u,v);
    end
...
function [] = calculate_energy1(out1,out2,t,phi,u,v)
global  epsilon lambda phi_init
if t == 0
    phi0 = phi_init;
end
