...
hold on
plot(mass2(tmp:1:end,1),abs((mass2(tmp:1:end,3)-mass2(1,3))./mass2(1,3))+0.0001,'-','LineWidth',2.5,'Color',fillcolor1);
hold on
...
figname2 = ['C:\Users\heyan\Desktop\some files\figs\deformation\01nonlinear_bdf2_CAC_Vesicles_data_LM_two_circles\',scheme1,'_and_',scheme2,'_and_',scheme3,'_stability_surface_2D','.png'];
